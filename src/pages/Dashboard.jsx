          ...
          {totalBugs === 0 ? (
            ...
            <div className="flex items-center gap-6">
              ...
              <ul className="min-w-0 flex-1 space-y-2">
                {bug_status_breakdown.map((entry) => (
                  <li key={entry.status} className="flex items-center justify-between gap-2 text-sm">
                    <span className="flex min-w-0 items-center gap-2 text-slate-600">
                      <span className="h-2 w-2 shrink-0 rounded-full" style={{ backgroundColor: STATUS_COLORS[entry.status] }} />
